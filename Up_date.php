    ...
    <div class="row  box8">
      ...
      <div class="col-sm-6 form-group">
        ...
        <select id="sub_caste" name="sub_caste" class="form-control browser-default custom-select" >
          ...
          <option value="Nanjil Mundali">Nanjil Mundali</option>
          ...
          <option value="Shoziya Vellalar">Shoziya Vellalar</option>
          <option value="Thondal Mandala Vellalar">Thondal Mandala Vellalar</option>
      ...
      <!-- <br></br> -->
        <button class="btn btn-primary float-right" type="submit" name="update_details">Submit</button>
      </div>

...
if(isset($_SESSION['adminname']))
{
   ...
   $indicator1 = $count."%";
    ...
    $query = "SELECT COUNT(*) as paidusers FROM `signup` WHERE `status` = 'paid'";
    $result = mysqli_query($conn,$query);
    $row = mysqli_fetch_array($result);
    ...
    $query = "SELECT COUNT(*) as male FROM `signup` WHERE sex = 'male'";
    $result = mysqli_query($conn,$query);
    $row = mysqli_fetch_array($result);
    $male = $row['male'];
    $indicator3 = $male."%";
    ...
    $query = "SELECT COUNT(*) as female FROM `signup` WHERE sex = 'female'";
    $result = mysqli_query($conn,$query);
    $row = mysqli_fetch_array($result);
    $female = $row['female'];
    $indicator4 = $female."%";
                        ...
                        <table width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th><span class="las la-calculator"></span> LAST LOGIN</th>
